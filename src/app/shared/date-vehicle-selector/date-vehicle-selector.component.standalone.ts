...
@Component({
  selector: 'app-date-vehicle-selector-standalone',
  templateUrl: './date-vehicle-selector.component.standalone.html',
...
export class DateVehicleSelectorStandaloneComponent implements OnInit {
